# Домашнее задание к занятию 1 «Disaster recovery и Keepalived» Федоров Дмитрий
...
4. Просмотрены конфигурационные файлы, рассматриваемые на лекции, которые находятся по [ссылке](https://github.com/netology-code/sflt-homeworks/tree/main/1))
